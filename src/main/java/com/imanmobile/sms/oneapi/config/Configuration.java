package com.imanmobile.sms.oneapi.config;

import java.io.File;

import com.imanmobile.sms.oneapi.exception.ConfigurationException;
...
public class Configuration  {
    ...
    public Configuration(Authentication authentication) {
