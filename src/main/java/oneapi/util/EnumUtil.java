...
public final class EnumUtil implements Serializable {
	 ...
	 * using {@link oneapi.util.EnumUtil.IEnumIntValue#getValue()}.
	 *  
	 * @param <T> enumeration class which must implement {@link oneapi.util.EnumUtil.IEnumIntValue}
	 ...
	 * To get O(1) performace {@link oneapi.util.EnumUtil.EnumMapper} should be used which can return enumeration constant for specified value in constant time.
	 * <br>
	 *      
	 * @param <T>
	 * @param enumClass
	 ...
	 * @author mzagar
	 *
	 * @param <T> enumeration type - must implement {@link oneapi.util.EnumUtil.IEnumIntValue}
	 */
	public static class EnumMapper<T extends IEnumIntValue> {
		 ...
		 * <br>
		 * Returns same value as {@link oneapi.util.EnumUtil.IEnumIntValue#getValue()}.
		 *  
